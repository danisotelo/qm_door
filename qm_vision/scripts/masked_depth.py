...
class ClusterDetector():
    ...
    def depth_callback(self, data: Image):
        try:
            ...
            depth_mat = self.bridge.imgmsg_to_cv2(data, desired_encoding="passthrough")
            ...
            if self.image_data is not None:
                ...
                res = cv_depth.copy()
                res[self.image_data == 0] = 0  # Masking depth data
                ...
                # Convert the masked depth image back to ROS Image message
                masked_depth_msg = self.bridge.cv2_to_imgmsg(res, encoding="16UC1")
